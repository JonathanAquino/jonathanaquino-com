...
def extended_descriptions(url)
  ...
  extended_descriptions = "&lt;span class='descriptious-tags'&gt;(" + tags[0..3].join(", ") + ")&lt;/span&gt; &lt;span class='descriptious-extended-descriptions'&gt;" + extended_descriptions[0..300] + "&lt;/span&gt;"
  if extended_descriptions.length > 0
    extended_descriptions = "&lt;a class='descriptious-delicious-url' href='#{delicious_url}'&gt;[D]&lt;/a&gt; " + extended_descriptions
  end
end
